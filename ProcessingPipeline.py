...
class ProcessingPipeline:
    ...
    def process_secondhand(self):
        ...
        for index in range(0, len(self.config_dict["pictures"])):
            ...
            pic.set_name_eng_font(self.config_dict["others"]["name_eng_font"], self.config_dict["others"]["name_eng_fontsize"])
            pic.set_name_eng_color(self.config_dict["others"]["name_eng_color"])
            pic.set_name_eng_bg_color(self.config_dict["others"]["name_eng_bg_color"])
